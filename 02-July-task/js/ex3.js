...
// tr.innerHTML = '<th>Country</th><th>code</th><th>Unicode</th><th>Image</th>'
// thead.innerHTML = tr.outerHTML

// let domscript3 = ex3.map((item) => {
//   tr.innerHTML = `<td>${item.name}</td><td>${item.code}</td><td>${item.unicode}</td><td><img src="${item.image}" alt="${item.name}"></td>`
