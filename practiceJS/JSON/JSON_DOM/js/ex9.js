...
let appfilter9= document.querySelector('#filter')
let appreduce9= document.querySelector('#reduce')
...
let filterdemoscript9= ex9.filter((item) =>{
    item.numericalArray.length > 5;
    return item.numericalArray;
})

 let reducedemoscript9= ex9.reduce((acc, item) => {
...
appfilter9.innerHTML = (filterdemoscript9);
appreduce9.innerHTML = reducedemoscript9;
